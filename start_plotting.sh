...
# path="/mnt/wwn-0x50000395b2b85149-part1/PreparedData/EG1/2020_10_29_pp13TeV_background_JJMC/" # mnt/wwn-0x50000395b2b85149-part1/PreparedData/EG1/2020_09_03_pp_13TeV_Pi0Rotation/MC/
...
#       rm -rf "Data/EG1/"${OutputFiles[$i]}"/"${modenames[$j]}"/"$val
#       mkdir -p "Data/EG1/"${OutputFiles[$i]}"/"${modenames[$j]}"/"$val
